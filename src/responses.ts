...
/** Create or update the metadata of an Iot hub. The usual pattern to modify a property is to retrieve the IoT hub metadata and security metadata, and then combine them with the modified values in a new body to update the IoT hub. */
export interface IotHubResourceCreateOrUpdatedefaultResponse
...
export interface IotHubResourceListBySubscription200Response
  extends HttpResponse {
  status: "200";
...
/** Get all the IoT hubs in a subscription. */
export interface IotHubResourceListBySubscriptiondefaultResponse
  extends HttpResponse {
  status: "500";
  body: ErrorDetails;
}
...
export interface IotHubResourceListByResourceGroup200Response
  extends HttpResponse {
  status: "200";
  body: IotHubDescriptionListResult;
}
...
/** Get all the IoT hubs in a resource group. */
export interface IotHubResourceListByResourceGroupdefaultResponse
  extends HttpResponse {
  status: "500";
  body: ErrorDetails;
}
...
/** Get the list of valid SKUs for an IoT hub. */
export interface IotHubResourceGetValidSkusdefaultResponse
  extends HttpResponse {
  status: "500";
  body: ErrorDetails;
}
...
export interface IotHubResourceListEventHubConsumerGroups200Response
  extends HttpResponse {
  status: "200";
...
/** Get a list of the consumer groups in the Event Hub-compatible device-to-cloud endpoint in an IoT hub. */
export interface IotHubResourceListEventHubConsumerGroupsdefaultResponse
  extends HttpResponse {
  status: "500";
  body: ErrorDetails;
}
...
export interface IotHubResourceGetEventHubConsumerGroup200Response
  extends HttpResponse {
  status: "200";
...
/** Get a consumer group from the Event Hub-compatible device-to-cloud endpoint for an IoT hub. */
export interface IotHubResourceGetEventHubConsumerGroupdefaultResponse
  extends HttpResponse {
  status: "500";
  body: ErrorDetails;
}
...
export interface IotHubResourceCreateEventHubConsumerGroup200Response
  extends HttpResponse {
  status: "200";
  body: EventHubConsumerGroupInfo;
}
...
/** Add a consumer group to an Event Hub-compatible endpoint in an IoT hub. */
export interface IotHubResourceCreateEventHubConsumerGroupdefaultResponse
  extends HttpResponse {
  status: "500";
  body: ErrorDetails;
}
...
export interface IotHubResourceDeleteEventHubConsumerGroup200Response
  extends HttpResponse {
  status: "200";
}

/** Delete a consumer group from an Event Hub-compatible endpoint in an IoT hub. */
export interface IotHubResourceDeleteEventHubConsumerGroupdefaultResponse
  extends HttpResponse {
  status: "500";
  body: ErrorDetails;
}
...
/** Get the quota metrics for an IoT hub. */
export interface IotHubResourceGetQuotaMetricsdefaultResponse
  extends HttpResponse {
  status: "500";
  body: ErrorDetails;
}
...
export interface IotHubResourceGetEndpointHealth200Response
  extends HttpResponse {
  status: "200";
...
/** Get the health for routing endpoints. */
export interface IotHubResourceGetEndpointHealthdefaultResponse
  extends HttpResponse {
  status: "500";
  body: ErrorDetails;
}
...
export interface IotHubResourceCheckNameAvailability200Response
  extends HttpResponse {
  status: "200";
...
/** Check if an IoT hub name is available. */
export interface IotHubResourceCheckNameAvailabilitydefaultResponse
  extends HttpResponse {
  status: "500";
  body: ErrorDetails;
}
...
/** Test all routes configured in this Iot Hub */
export interface IotHubResourceTestAllRoutesdefaultResponse
  extends HttpResponse {
  status: "500";
  body: ErrorDetails;
}
...
export interface IotHubResourceGetKeysForKeyName200Response
  extends HttpResponse {
  status: "200";
...
/** Get a shared access policy by name from an IoT hub. For more information, see: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-security. */
export interface IotHubResourceGetKeysForKeyNamedefaultResponse
  extends HttpResponse {
  status: "500";
  body: ErrorDetails;
}
...
/** Exports all the device identities in the IoT hub identity registry to an Azure Storage blob container. For more information, see: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-identity-registry#import-and-export-device-identities. */
export interface IotHubResourceExportDevicesdefaultResponse
  extends HttpResponse {
  status: "500";
  body: ErrorDetails;
}
...
/** Import, update, or delete device identities in the IoT hub identity registry from a blob. For more information, see: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-identity-registry#import-and-export-device-identities. */
export interface IotHubResourceImportDevicesdefaultResponse
  extends HttpResponse {
  status: "500";
  body: ErrorDetails;
}
...
export interface ResourceProviderCommonGetSubscriptionQuota200Response
  extends HttpResponse {
  status: "200";
...
/** Get the number of free and paid iot hubs in the subscription */
export interface ResourceProviderCommonGetSubscriptionQuotadefaultResponse
  extends HttpResponse {
  status: "500";
  body: ErrorDetails;
}
...
export interface CertificatesGenerateVerificationCode200Response
  extends HttpResponse {
  status: "200";
...
/** Generates verification code for proof of possession flow. The verification code will be used to generate a leaf certificate. */
export interface CertificatesGenerateVerificationCodedefaultResponse
  extends HttpResponse {
  status: "500";
  body: ErrorDetails;
}
...
/** Update the status of a private endpoint connection with the specified name */
export interface PrivateEndpointConnectionsUpdate201Response
  extends HttpResponse {
  status: "201";
  body: PrivateEndpointConnection;
}
